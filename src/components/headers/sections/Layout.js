                ...
                <div key={this.props.uid + 2} id={"VisualEditorOuterMainContainer_" + this.props.uid + 2}>
                    ...
                    <div key={this.props.uid + 7} className="VisualEditorContainerDiv">
                        <div key={this.props.uid + 8} className="VisualEditor_ComboBoxRight">
                            ...
                            <button key={this.props.uid + 16} className="VisualEditor_ComboBoxRight_Button VisualButton">Icon
                            </button>
                            <button key={this.props.uid + 17} className="VisualEditor_ComboBoxRight_Button VisualButton">Beam
                            </button>
                        </div>
                        <div key={this.props.uid + 18} className="VisualEditor_ComboBoxLeft">
                            <div key={this.props.uid + 19} className="VisualEditor_ComboBoxColorPickerDiv">
                                <div key={this.props.uid + 20}
                                     className="VisualEditor_ComboBoxEnabledColor selectedSocket"></div>
                                <label key={this.props.uid + 21} className="VisualEditor_ComboBoxLeftLabel">TX</label>
                            ...
                            <div key={this.props.uid + 22} className="VisualEditor_ComboBoxColorPickerDiv">
                                <div key={this.props.uid + 23}
                                     className="VisualEditor_ComboBoxEnabledColor selectedSocket"></div>
                                <label key={this.props.uid + 24} className="VisualEditor_ComboBoxLeftLabel">BD</label>
                            ...
                            <div key={this.props.uid + 25} className="VisualEditor_ComboBoxColorPickerDiv">
                                <div key={this.props.uid + 26}
                                     className="VisualEditor_ComboBoxEnabledColor selectedSocket"></div>
                                <label key={this.props.uid + 27} className="VisualEditor_ComboBoxLeftLabel">BG</label>
                                {/*<input key={props.uid} className="SpectrumColorPicker" style="display: none;" />*/}
                                {/*<div class="sp-replacer sp-light">
                                    <div class="sp-preview">
                                        <div class="sp-preview-inner"></div>
                        ...
                        <div key={this.props.uid + 28} className="VisualEditorShowCaseDiv">
                            <div key={this.props.uid + 29} className="VisualEditor_InnerItem">
                                <div key={this.props.uid + 30} className="InnerItemContainer">
                                    <div key={this.props.uid + 31} className="ItemDiv">
                                        <label key={this.props.uid + 32} className="ItemTextLabel">Item Name</label>
